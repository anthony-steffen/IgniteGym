  ...
  return (
    <section className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="stat bg-base-100 shadow rounded-box border-none">
        ...
        <div className="stat-title text-xs uppercase font-bold text-base-content/60">Ativos</div>
      ...
      <div className="stat bg-base-100 shadow rounded-box border-none">
        ...
        <div className="stat-title text-xs uppercase font-bold text-base-content/60">Novos (Mes)</div>
      ...
      <div className="stat bg-base-100 shadow rounded-box border-none">
        ...
        <div className="stat-title text-xs uppercase font-bold text-base-content/60">Pendencias</div>
